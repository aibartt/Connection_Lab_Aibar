let planets = []
// Code for p5 animation of planet movements in Solar system
function setup() {
  var canvas = createCanvas(800, 800)
  canvas.parent('sketch-holder');
  //color of differnet planets in p5 animation
  ...
  //physical properties of differnet planets in p5 animation
...
//function to display p5 animation and movement of differnet planets in Solar system
function draw() {
  background(43)
